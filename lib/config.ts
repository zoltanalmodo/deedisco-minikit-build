...
export const config = {
  ...
  nftContractAddress: process.env.NEXT_PUBLIC_NFT_CONTRACT_ADDRESS || '0x86B95e4E7c21bC9C349ABE6Be0f89193baF1b8d6', // FIXED CONTRACT - Stores card IDs for correct metadata!
